...
<html lang="pt">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <form action="RelatorioVendas" method="POST" id="formRelatorioVendas">
                    <input type="submit" id="btnVendas" name="btnVendas">
                </form>
                <form action="Log" method="POST" id="formLog">
                    <input type="submit" id="btnLog" name="btnLog">
                </form>
            </div>
