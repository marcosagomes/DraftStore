...
function validaNumero() {
    ...
    if (valorDoCampo == "" || valorDoCampo.length < 1) {
        ...
        campoNumero.classList.add("has-success");
        return true;
    }
}
function validaRazaoSocial() {
    ...
    if (valorDoCampo == "" || valorDoCampo.length < 3) {
        ...
        campoRazaoSocial.classList.add("has-success");
...
function validaCNPJ() {
    ...
    if (!regex.test(valorDoCampo) || !isCNPJValid(valorDoCampo)) {
        ...
        campoCNPJ.classList.add("has-success");
        return true;
    }
}
function validaCEP() {
    ...
    if (!regex.test(valorDoCampo)) {
        ...
        campoCep.classList.add("has-success");
        return true;
    }
}
...
function validaSite() {
    ...
    if (!regex.test(valorDoCampo)) {
        ...
        campoSite.classList.add("has-success");
        return true;
    }
}
